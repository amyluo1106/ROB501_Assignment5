...
class CNN(torch.nn.Module):
    def __init__(self, num_bins): 
        ...
        self.conv1 = torch.nn.Conv2d(3, 10, stride=3, padding = 3, kernel_size=(9,9)) # 3 input channels, 16 output channels
        self.dropout = torch.nn.Dropout(0.1)
        self.batchNorm1 = torch.nn.BatchNorm2d(10)
        self.pool1 = torch.nn.MaxPool2d((3,3),stride=3)
        self.relu = torch.nn.ReLU()
        self.conv2 = torch.nn.Conv2d(10, 32, stride=1, kernel_size=(5,5))
        self.batchNorm2 = torch.nn.BatchNorm2d(32)
        self.pool2 = torch.nn.MaxPool2d((2,2),stride=2)
        self.conv3 = torch.nn.Conv2d(32,num_bins, kernel_size=(1,10))
...
class dataloader(torch.utils.data.Dataset):
    ...
    def __init__(self, matfile, binsize=45, mode='train'):
        ...
        # Data to zero mean.
        self.data['images'] = self.normalize_to_zero_mean()

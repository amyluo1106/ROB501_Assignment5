...
class CNN(torch.nn.Module):
    def __init__(self, num_bins):
        ...
        self.conv1 = torch.nn.Conv2d(3, 16, stride=4, padding = 1, kernel_size=(7, 7))
        self.pool1 = torch.nn.MaxPool2d((3, 3), stride=3)

        # Additional Convolutional Layer
        self.conv2 = torch.nn.Conv2d(16, 16, stride = 1, padding = 1, kernel_size=(5, 5))
        self.pool2 = torch.nn.MaxPool2d((3, 3), stride=3)

        self.conv3 = torch.nn.Conv2d(16, num_bins, kernel_size=(1, 5))
